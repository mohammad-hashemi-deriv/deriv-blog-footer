...
function my_custom_footer_scripts()
{
	...
	echo "<a href='https://api.deriv.com/docs/quickstart'>
				<li>API</li>
			</a>
			<a href='$base_url/bug-bounty/'>
				<li>Bug bounty</li>
			</a>
		</ul>
		<ul class='footer--menu--col'>
	...
	if (!$is_eu) {
		echo "
			<p class='license'>
				...
				under the Investment Services Act <a href='$base_url/regulatory/Deriv_Investments_(Europe)_Limited.pdf'>(licence)</a>.
	...
	echo "<p>
		...
		<p>
			Make sure to read our <a href='$base_url/terms-and-conditions/#clients' target='_blank'>Terms
				and conditions</a>, <a href='$base_url/tnc/risk-disclosure.pdf' target='_blank'>Risk
				disclosure</a>, and <a href='$base_url/responsible/' target='_blank'>Secure and responsible
			</a> trading to fully
			understand the risks involved before using our services. Please also note that the information on this
